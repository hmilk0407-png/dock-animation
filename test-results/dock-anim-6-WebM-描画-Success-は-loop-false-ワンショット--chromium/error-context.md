...
- Name: dock-anim.spec.ts >> 6. WebM 描画 >> Success は loop=false (ワンショット)
- Location: e2e/dock-anim.spec.ts:135:7
...
Error: strict mode violation: getByTestId('milk-clip-video') resolved to 2 elements:
    1) <video width="160" autoplay="" height="160" playsinline="" data-testid="milk-clip-video" src="/milk/success/milk_success.webm"></video> aka getByTestId('milk-clip-video').first()
    2) <video width="48" height="48" autoplay="" playsinline="" data-testid="milk-clip-video" src="/milk/success/milk_success.webm"></video> aka getByTestId('milk-clip-video').nth(1)
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e12]:
          - text: 成功
          - generic [ref=e13]: success
        - generic [ref=e14]: 跳ねて舌ペロ→末尾静止(WebM・1.8秒/1回・1.8秒後に待機へ)
      ...
      - generic [ref=e20]:
        ...
        - button "成功 success" [active] [ref=e25] [cursor=pointer]:
          - text: 成功
        ...
        - button "傾聴 listening" [ref=e31] [cursor=pointer]:
          - text: 傾聴
