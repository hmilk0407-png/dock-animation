...
- Name: dock-anim.spec.ts >> 4. PNGseq フレーム進行 (簡易) >> Thinking の <img> src が連番で変化する
- Location: e2e/dock-anim.spec.ts:93:7
...
Error: strict mode violation: getByTestId('milk-clip-pngseq') resolved to 2 elements:
    1) <img alt="" width="160" height="160" data-testid="milk-clip-pngseq" src="/milk/thinking/thinking_0007.png"/> aka getByTestId('milk-clip-pngseq').first()
    2) <img alt="" width="48" height="48" data-testid="milk-clip-pngseq" src="/milk/thinking/thinking_0007.png"/> aka getByTestId('milk-clip-pngseq').nth(1)
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e9]:
        ...
        - generic [ref=e11]:
          - text: 考え中
          - generic [ref=e12]: thinking
        - generic [ref=e13]: 上目づかいで思案(PNG連番180枚・6秒ループ)
      ...
      - generic [ref=e18]:
        ...
        - button "考え中 thinking" [active] [ref=e27] [cursor=pointer]:
          - text: 考え中
        ...
        - button "びっくり surprised" [ref=e33] [cursor=pointer]:
          - text: びっくり
