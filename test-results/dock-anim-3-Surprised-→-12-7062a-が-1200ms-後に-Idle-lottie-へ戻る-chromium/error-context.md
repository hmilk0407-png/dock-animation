...
- Name: dock-anim.spec.ts >> 3. Surprised → 1200ms → Idle (expect.poll で安定化) >> Surprised(pngseq) が 1200ms 後に Idle(lottie) へ戻る
- Location: e2e/dock-anim.spec.ts:74:7
...
Error: strict mode violation: getByTestId('milk-clip-pngseq') resolved to 2 elements:
    1) <img alt="" width="160" height="160" data-testid="milk-clip-pngseq" src="/milk/surprised/surprised_0009.png"/> aka getByTestId('milk-clip-pngseq').first()
    2) <img alt="" width="48" height="48" data-testid="milk-clip-pngseq" src="/milk/surprised/surprised_0009.png"/> aka getByTestId('milk-clip-pngseq').nth(1)
