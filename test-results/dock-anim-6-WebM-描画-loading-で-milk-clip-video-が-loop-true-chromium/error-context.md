...
- Name: dock-anim.spec.ts >> 6. WebM 描画 >> loading で milk-clip-video が loop=true
...
Error: strict mode violation: getByTestId('milk-clip-video') resolved to 2 elements:
    1) <video loop="" width="160" autoplay="" height="160" playsinline="" data-testid="milk-clip-video" src="/milk/loading/milk_loading.webm"></video> aka getByTestId('milk-clip-video').first()
    2) <video loop="" width="48" height="48" autoplay="" playsinline="" data-testid="milk-clip-video" src="/milk/loading/milk_loading.webm"></video> aka getByTestId('milk-clip-video').nth(1)
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e14]: 伏し目でじっと待つ(WebM・6秒ループ)
      ...
      - generic [ref=e20]:
        ...
        - button "処理中 loading" [active] [ref=e33] [cursor=pointer]:
          - text: 処理中
