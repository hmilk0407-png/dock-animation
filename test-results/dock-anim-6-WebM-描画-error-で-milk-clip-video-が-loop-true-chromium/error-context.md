...
- Name: dock-anim.spec.ts >> 6. WebM 描画 >> error で milk-clip-video が loop=true
...
Error: strict mode violation: getByTestId('milk-clip-video') resolved to 2 elements:
    1) <video loop="" width="160" autoplay="" height="160" playsinline="" data-testid="milk-clip-video" src="/milk/error/milk_error.webm"></video> aka getByTestId('milk-clip-video').first()
    2) <video loop="" width="48" height="48" autoplay="" playsinline="" data-testid="milk-clip-video" src="/milk/error/milk_error.webm"></video> aka getByTestId('milk-clip-video').nth(1)
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e14]: 首をかしげて困り顔(WebM・2.3秒ループ)
      ...
      - generic [ref=e20]:
        ...
        - button "エラー error" [active] [ref=e27] [cursor=pointer]:
          - text: エラー
