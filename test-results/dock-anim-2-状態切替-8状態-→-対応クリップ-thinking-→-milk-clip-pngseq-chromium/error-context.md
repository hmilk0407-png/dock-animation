...
- Name: dock-anim.spec.ts >> 2. 状態切替 (8状態) → 対応クリップ >> thinking → milk-clip-pngseq
...
Error: strict mode violation: getByTestId('milk-clip-pngseq') resolved to 2 elements:
    1) <img alt="" width="160" height="160" data-testid="milk-clip-pngseq" src="/milk/thinking/thinking_0006.png"/> aka getByTestId('milk-clip-pngseq').first()
    2) <img alt="" width="48" height="48" data-testid="milk-clip-pngseq" src="/milk/thinking/thinking_0006.png"/> aka getByTestId('milk-clip-pngseq').nth(1)
