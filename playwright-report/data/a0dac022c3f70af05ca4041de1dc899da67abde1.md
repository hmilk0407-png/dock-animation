...
- Name: dock-anim.spec.ts >> 6. WebM 描画 >> focus で milk-clip-video が loop=true
...
Error: strict mode violation: getByTestId('milk-clip-video') resolved to 2 elements:
    1) <video loop="" width="160" autoplay="" height="160" playsinline="" data-testid="milk-clip-video" src="/milk/focus/milk_focus.webm"></video> aka getByTestId('milk-clip-video').first()
    2) <video loop="" width="48" height="48" autoplay="" playsinline="" data-testid="milk-clip-video" src="/milk/focus/milk_focus.webm"></video> aka getByTestId('milk-clip-video').nth(1)
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e12]:
          - text: 集中
          - generic [ref=e13]: focus
        - generic [ref=e14]: 入力に注目。耳ピン(WebM・1.4秒ループ)
        - generic [ref=e16]: "Dock実寸(48px):"
      - generic [ref=e20]:
        - button "待機 idle" [ref=e21] [cursor=pointer]:
          - text: 待機
          - generic [ref=e22]: idle
        - button "集中 focus" [active] [ref=e23] [cursor=pointer]:
          - text: 集中
