...
- Name: dock-anim.spec.ts >> 6. WebM 描画 >> listening で milk-clip-video が loop=true
- Location: e2e/dock-anim.spec.ts:127:9
...
Locator: getByTestId('milk-clip-video')
Expected: visible
Error: strict mode violation: getByTestId('milk-clip-video') resolved to 2 elements:
    1) <video loop="" width="160" autoplay="" height="160" playsinline="" data-testid="milk-clip-video" src="/milk/listening/milk_listening.webm"></video> aka getByTestId('milk-clip-video').first()
    2) <video loop="" width="48" height="48" autoplay="" playsinline="" data-testid="milk-clip-video" src="/milk/listening/milk_listening.webm"></video> aka getByTestId('milk-clip-video').nth(1)

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByTestId('milk-clip-video')
...
- generic [ref=e1]:
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e10]:
        - generic [ref=e11]: 現在の状態
        - generic [ref=e12]:
          - text: 傾聴
          - generic [ref=e13]: listening
        - generic [ref=e14]: 耳を前に向けて聞いている(WebM・6秒ループ)
        - generic [ref=e16]: "Dock実寸(48px):"
      - generic [ref=e20]:
        - button "待機 idle" [ref=e21] [cursor=pointer]:
          - text: 待機
          - generic [ref=e22]: idle
        - button "集中 focus" [ref=e23] [cursor=pointer]:
          - text: 集中
          - generic [ref=e24]: focus
        - button "成功 success" [ref=e25] [cursor=pointer]:
          - text: 成功
          - generic [ref=e26]: success
        - button "エラー error" [ref=e27] [cursor=pointer]:
          - text: エラー
          - generic [ref=e28]: error
        - button "考え中 thinking" [ref=e29] [cursor=pointer]:
          - text: 考え中
          - generic [ref=e30]: thinking
        - button "傾聴 listening" [active] [ref=e31] [cursor=pointer]:
          - text: 傾聴
          - generic [ref=e32]: listening
        - button "処理中 loading" [ref=e33] [cursor=pointer]:
          - text: 処理中
          - generic [ref=e34]: loading
        - button "びっくり surprised" [ref=e35] [cursor=pointer]:
          - text: びっくり
          - generic [ref=e36]: surprised
      - generic [ref=e37]:
        - 'button "動きを減らす(reduced-motion): off" [ref=e38] [cursor=pointer]'
        - generic [ref=e39]: on にすると全状態が静止画になります(アクセシビリティ確認用)
  - alert [ref=e40]
```
